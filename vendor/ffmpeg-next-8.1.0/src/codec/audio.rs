...
impl Audio {
    pub fn rates(&self) -> Option<RateIter> {
        ...
        unsafe {
            return self
                .codec
                .supported_config(AVCodecConfig::AV_CODEC_CONFIG_SAMPLE_RATE)
                .map(RateIter::new);
        }
    ...
    pub fn formats(&self) -> Option<FormatIter> {
        ...
        unsafe {
            return self
                .codec
                .supported_config(AVCodecConfig::AV_CODEC_CONFIG_SAMPLE_FORMAT)
                .map(FormatIter::new);
        }
    ...
    pub fn channel_layouts(&self) -> Option<ChannelLayoutIter> {
        ...
        unsafe {
            return self
                .codec
                .supported_config(AVCodecConfig::AV_CODEC_CONFIG_CHANNEL_LAYOUT)
                .map(ChannelLayoutIter::new);
        }
